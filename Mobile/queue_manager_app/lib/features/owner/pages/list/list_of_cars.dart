                  ...
                  return GestureDetector(
                    ...
                    child: Card(
                      ...
                      elevation:
                          6.0,
                      shadowColor:
                          Colors.black.withOpacity(0.3), // Soft shadow color
                      color: Colors.white, // White background for the card
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(
                            8.0), // Rounded corners for a modern look
                      ),
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          color: AppColors.getCarColor(car.color),
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        style: TextStyle(
                                          fontSize: 14.0,
                                          color: AppColors
                                              .darkNavBarBackground, // Use lightGray
                                        ),
                                      ),
                                      Container(
